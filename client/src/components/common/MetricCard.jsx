...
const MetricCard = memo(function MetricCard({ label, value, subtext, accent = 'indigo' }) {
  ...
  return (
    <article
      className={`rounded-2xl border border-gray-200/80 bg-linear-to-br ${gradient} bg-white p-6 shadow-sm transition-all duration-200 hover:scale-[1.01] hover:shadow-lg dark:border-gray-800 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 dark:bg-gray-900`}
    >
